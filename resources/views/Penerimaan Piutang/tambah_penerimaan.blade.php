...
<div class="row">
	<div class="col-md-12">
		<form action="/penerimaan_piutang/create" method="POST">

			@csrf

			<div class="card" style="border-top: 3px solid #9C5C22">
				<div class="card-header">
					<h3 class="card-title">Tambah Penerimaan Piutang Solar</h3>
				</div>
				...
				<div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="">Tanggal Penerimaan Solar</label>
				...
				<div class="card-footer">
					...
					<a href="/penerimaan_piutang" class="btn btn-default">Back</a>
                    &nbsp;&nbsp;

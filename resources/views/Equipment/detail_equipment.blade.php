            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text " name="equipment_info" value="{{ $equipment->equipment_info }}" class="form-control" disabled autofocus>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="equipment_number" value="{{$equipment->equipment_number}}" class="form-control" disabled>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {{ Form::select('equipment_type', $tipe, $equipment->equipment_type, ['placeholder' => 'Pilih Tipe Equipment....', 'disabled', 'class' => 'form-control'])}}
                    </div>

                    <div class="form-group">
                        <label>Manufacture</label>
                        {{ Form::select('manufacture_id', $manufactures, $equipment->manufacture_id, ['placeholder' => 'Pilih Manufacture....', 'disabled', 'class' => 'form-control'])}}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="equipment_name" value="{{$equipment->equipment_name}}" class="form-control" disabled autofocus>
                    </div>
                    
                    <div class="form-group">
                        <label>Location</label>
                        <input type="text" name="location" value="{{$equipment->location}}" class="form-control" disabled autofocus>
                    </div>

                    <div class="form-group">
                        <label>Fuel Capacity</label>
                        <input type="text" name="fuel_capacity" value="{{$equipment->fuel_capacity}}" class="form-control" disabled autofocus>
                    </div>

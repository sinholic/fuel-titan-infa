...
{{-- Notifikasi form validasi --}}
    ...
    <a href="/mobile/export_excel" class="btn btn-success my-1" target="_blank">
        <i class="fas fa-file-excel"></i> Export Excel
    </a>
    
        <a href="/tampiladdmobile" class="btn btn-primary">
...
<div class="card" style="border-top: 3px solid #9C5C22">
                ...
                <tr>
                    ...
                    <td>
                         <div class="btn-group">
                            ...
                            <a href="/mobile/edit/{{$s->id}}" class="btn btn-warning  btn-sm" data-toggle="tootip" data-placement="bottom" title="Edit">
                                <i class="fa fa-edit nav-icon"></i>
                            </a>

                            <a href="#" class="btn btn btn-danger btn-sm delete" mobile-station-id="{{$s->id}}">
 ...
 <!-- Import Excel -->
        ...
        $('.delete').click(function(){
            var mobile_station_id = $(this).attr('mobile-station-id');
            swal({
            title: "Are you sure?",
            text: "Anda yakin akan menghapus data dengan id "+mobile_station_id+ "?",
            icon: "warning",
            buttons: true,
            dangerMode: true, 
            })
            ...
            if (willDelete) {
            window.location = "/mobile/"+mobile_station_id+"/delete"
            }
            });
        });
    </script>

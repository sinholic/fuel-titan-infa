            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
						...
						{{ Form::select('owner_category', ['Internal' => 'Internal', 'External' => 'External'], $owner->owner_category, ['placeholder' => 'Pilih kategori...', 'required', 'class' => 'form-control', 'disabled' => 'disabled']) }}
                    </div>

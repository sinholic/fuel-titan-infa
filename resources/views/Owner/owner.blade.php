                ...
                <tr>
                    ...
                    <td>
                         <div class="btn-group">
                            ...
                            <a href="/owner/edit/{{$s->id}}" class="btn btn-warning  btn-sm" data-toggle="tootip" data-placement="bottom" title="Edit">
                                <i class="fa fa-edit nav-icon"></i>
                            </a>

                            <a onClick="return confirm('Yakin ingin menghapus data?')" href="/owner/{{$s->id}}/delete" class="btn btn btn-danger btn-sm">

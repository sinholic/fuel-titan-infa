                ...
                <tr>
                    ...
                    <td>
                         <div class="btn-group">
                            ...
                            <a href="#" class="btn btn btn-danger btn-sm delete" tipe-equipment-id="{{$s->id}}">
...
<script>
    $('.delete').click(function(){
        var tipe_equipment_id = $(this).attr('tipe-equipment-id');
        ...
        if (willDelete) {
           window.location = "/tipe_equipment/"+tipe_equipment_id+"/delete"
        }
        });
    });
</script>
